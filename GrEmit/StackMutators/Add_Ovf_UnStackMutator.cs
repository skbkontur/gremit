...
{
    internal class Add_Ovf_UnStackMutator : ArithmeticBinOpStackMutator
    {
        public Add_Ovf_UnStackMutator(OpCode opCode)
            : base(opCode)
        {
            ...
            Allow(CLIType.Zero, CLIType.Int32, CLIType.Int64, CLIType.NativeInt, CLIType.Pointer, CLIType.Zero);
        }
