...
//                {OpCodes.Jmp, new JmpStackMutator()},
                ...
                {OpCodes.Add_Ovf, new NumericOpStackMutator(OpCodes.Add_Ovf)},
                {OpCodes.Add_Ovf_Un, new Add_UnStackMutator(OpCodes.Add_Ovf_Un)},
                {OpCodes.Sub, new Sub_UnStackMutator(OpCodes.Sub)},
                {OpCodes.Sub_Ovf, new NumericOpStackMutator(OpCodes.Sub_Ovf)},
                {OpCodes.Sub_Ovf_Un, new Sub_UnStackMutator(OpCodes.Sub_Ovf_Un)},
                {OpCodes.Mul, new NumericOpStackMutator(OpCodes.Mul)},
                {OpCodes.Mul_Ovf, new NumericOpStackMutator(OpCodes.Mul_Ovf)},
                {OpCodes.Mul_Ovf_Un, new NumericOpStackMutator(OpCodes.Mul_Ovf_Un)},
